...
const API = "http://localhost:3000"; // غيّرها لاحقًا لرابط API بعد النشر

const ADMIN = ["localhost", "127.0.0.1"].includes(location.hostname); // إدارة محلية فقط
...
// حمل الصورة المخزنة محليًا دائمًا (سريعة)
...
// حمل التعريف من API إن وجد، وإلا من التخزين المحلي
...
// حاول الحفظ في API، وإلا خزّن محليًا
...
// حفظ محلي بسيط حسب المفاتيح المرسلة
...
"<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 200 200'><rect width='200' height='200' fill='#0f172a'/><circle cx='100' cy='74' r='36' fill='#334155'/><rect x='28' y='126' width='144' height='50' rx='24' fill='#334155'/></svg>"
...
'<div class="content"><h3 class="title">لا توجد مقالات</h3><p class="date">ابدأ بإضافة أول مقال الآن</p></div>';
...
"<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 1200 675'><rect width='1200' height='675' fill='#0f172a'/><text x='50%' y='52%' font-size='56' fill='#fff' text-anchor='middle' font-family='system-ui,Segoe UI,Arial'>بدون صورة</text></svg>"
